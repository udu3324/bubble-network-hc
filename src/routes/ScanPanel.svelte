...
<div>
    ...
    <div class="w-full bg-slate-800 rounded-lg p-3 mt-8">
        <div>
            <button on:click={send} disabled={currentlyWaiting} class="mb-2"><i class="fa-solid fa-magnifying-glass"></i> Start Scan</button>
            <button on:click={clear} disabled={disableClearingData}><i class="fa-solid fa-trash-can"></i> Clear Network Data</button>
        </div>
